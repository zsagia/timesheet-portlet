		...
		try {
			List<TaskSession> taskSessions =
				TaskSessionLocalServiceUtil.getTaskSessionsByC_U_I(
					...
					TimeSheetUtil.getCurrentUserId(), currentDate,
					DateTimeUtil.getIncrementedDay(currentDate));
			...
			if (e instanceof TSStartTimeException) {
				...
				facesMessage = MessageUtil.getFacesMessage(
					FacesMessage.SEVERITY_ERROR,
					"start _session _validation _error", "no _start _time");
			}
				...
				facesMessage = MessageUtil.getFacesMessage(
					FacesMessage.SEVERITY_ERROR,
					"end _session _validation _error", "no _end _time");
			}
				...
				facesMessage = MessageUtil.getFacesMessage(
					FacesMessage.SEVERITY_ERROR, "validation _error",
					"exception");
			}
		}
