...
/**
 * Provides the local service interface for Day. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Istvan Sajtos, Zsolt Szabo
 * @see DayLocalServiceUtil
...
public interface DayLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DayLocalServiceUtil} to access the day local service. Add custom service methods to {@link com.liferay.timesheet.service.impl.DayLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
